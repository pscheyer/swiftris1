...
//  Swiftris1
//
//  Created by Peter Scheyer on 5/4/15.
...
protocol SwiftrisDelegate {
    //invoked when current round of swiftris ends
    ...
    //invoked the falling shape has changed its location
    func gameShapeDidMove(swiftris: Swiftris)
    
    //invoked the falling shape has changed its location after being dropped
